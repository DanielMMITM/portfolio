...
export const experience = [
  {
    ...
    tasks: [
      ...
      },
      {
        id: 3,
        taskDescES:
          'Uso de librerías para la administración de datos como zustand, tanstack query, etc.',
        taskDescEN:
          'Usage of libraries for data management such as zustand, tanstack query, etc.',
      },
      {
        id: 4,
        taskDescES:
  ...
  },
  {
    ...
    descEn: `This project was really a challenge for me due I didn't have the experience neither the knowledge, however it was possible to do it together with 2 other colleagues. The hardest part of this project was to search solutions for some problems because sometimes the documentation was outdated, furthermore I had to do a research on how to get done some tasks, mostly for the proper server configuration to deploy it.`,
    tasks: [
      {
        id: 1,
        taskDescES:
  ...
  },
  {
    ...
    descEn:
      'I did my social service/internship on this entity and I learned a lot of things. I participated on the system upgrading and migration to help improve the finantial area operations. It was a grateful experience since I learned a new framework which was laravel and I always was guided by my supervisor and he used to tell me some tips.',
    tasks: [
      {
        id: 1,
  ...
  },
  {
    ...
    descEn: `This project was developed by me and 4 more persons. We've developed a CMS (Content Management System) to allow the user manage it's own information which is displayed on the website. This software was about a website for technical residential services. This project was my first aproach into the real world since a teacher brought us this opportunity so we can learn a lot of things from it.`,
    tasks: [
      {
        id: 1,
        taskDescES:
